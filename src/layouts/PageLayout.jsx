      ...
      {roleArr.length !== 0 && (<div className="fixed h-screen z-10 top-0 left-0">
        <div className="flex">
          ...
          >
            ...
            {hasRequiredRole(roleArr, ["ADD_HOSPITAL", "HOSPITAL_LIST"]) && (
                <Accordion
                  open={open === 11}
                  icon={
                    !(isCollapsed & !isHovered) && (
                ...
                >
                  ...
                  {!(isCollapsed & !isHovered) && (
                    <AccordionBody className="py-1">
                      <List className="p-0" style={{ color: "#f1ffea" }}>
                      {hasRequiredRole(roleArr, ["ADD_HOSPITAL"]) && <ListItem
                          className="ml-9"
                          onClick={() => navigate("/hospital/add")}
                        >
                          Add Hospital
                        </ListItem>}
                        {hasRequiredRole(roleArr, ["HOSPITAL_LIST"]) && <ListItem
                          className="ml-9"
          ...
          {hasRequiredRole(roleArr, ["ADD_DIAGNOSIS", "DIAGNOSIS_LIST"]) && (
                <Accordion
                  open={open === 13}
                  icon={
                    !(isCollapsed & !isHovered) && (
                ...
                >
                  <ListItem className="p-0" selected={open === 13}>
                    <AccordionHeader
                  ...
                  {!(isCollapsed & !isHovered) && (
                    <AccordionBody className="py-1">
                      <List className="p-0" style={{ color: "#f1ffea" }}>
                        ...
                        {hasRequiredRole(roleArr, ["PATIENT_VITALS"]) && (
                          <ListItem
                            className="ml-9"
              ...
              {hasRequiredRole(roleArr, ["ADD_VISITING_SPECIALIST", "VISITING_SPECIALIST_LIST"]) && (
                  ...
                  >
                    <ListItem className="p-0" selected={open === 20}>
                      <AccordionHeader
